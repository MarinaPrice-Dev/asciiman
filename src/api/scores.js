...
export var submitScore = function (scoreData) { return __awaiter(void 0, void 0, void 0, function () {
    var baseUrl, response, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                console.log('Submitting score:', __assign(__assign({}, scoreData), { name: '[REDACTED]' }));
                baseUrl = import.meta.env.DEV ? 'http://localhost:3001' : '';
                return [4 /*yield*/, fetch("".concat(baseUrl, "/api/scores"), {
                        method: 'POST',
                        headers: {
